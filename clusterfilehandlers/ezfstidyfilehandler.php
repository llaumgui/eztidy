<?php
//
// Definition of eZFStidyFileHandler class
//
...
/*! \file ezfstidyfilehandler.php
*/
class eZFSTidyFileHandler extends eZFSFileHandler
{
    ...
    function storeContents( $contents, $scope = false, $datatype = false, $storeLocally = false )
    {
        ...
        $ezTidyCache->clean( $contents, $scope, $this->filePath );
